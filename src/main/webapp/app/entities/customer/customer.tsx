...
export interface ICustomerProps {
  getEntities: ICrudGetAllAction<ICustomer>;
  getSearchEntities: ICrudSearchAction<ICustomer>;
...
export class Customer extends React.Component<ICustomerProps, ICustomerState> {
  ...
  render() {
    ...
    return (
      <div>
        <h2 id="page-heading">
          <Translate contentKey="jhipsterMonolithicSampleApp.customer.home.title">Customers</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FaPlus />
            <Translate contentKey="jhipsterMonolithicSampleApp.customer.home.createLabel">Create new Customer</Translate>
          </Link>
        </h2>
        <div className="row">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('jhipsterMonolithicSampleApp.customer.home.search')}
                  />
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={this.sort('shardingId')}>
                  <Translate contentKey="jhipsterMonolithicSampleApp.customer.shardingId">Sharding Id</Translate> <FaSort />
                </th>
                <th />
              </tr>
            </thead>
