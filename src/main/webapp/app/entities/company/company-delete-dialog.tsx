...
export interface ICompanyDeleteDialogProps {
  getEntity: ICrudGetAction<ICompany>;
  deleteEntity: ICrudDeleteAction<ICompany>;
  company: ICompany;
  match: any;
  history: any;
}
...
export class CompanyDeleteDialog extends React.Component<ICompanyDeleteDialogProps> {
  ...
  confirmDelete = event => {
    this.props.deleteEntity(this.props.company.id);
  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody>
          <Translate contentKey="jhipsterMonolithicSampleApp.company.delete.question" interpolate={{ id: company.id }}>
