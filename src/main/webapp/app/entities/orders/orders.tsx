...
export interface IOrdersProps {
  getEntities: ICrudGetAllAction<IOrders>;
  getSearchEntities: ICrudSearchAction<IOrders>;
  ordersList: IOrders[];
  totalItems: 0;
  location: any;
  history: any;
...
export class Orders extends React.Component<IOrdersProps, IOrdersState> {
  ...
  render() {
    ...
    return (
      <div>
        <h2 id="page-heading">
          <Translate contentKey="jhipsterMonolithicSampleApp.orders.home.title">Orders</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FaPlus />
            <Translate contentKey="jhipsterMonolithicSampleApp.orders.home.createLabel">Create new Orders</Translate>
          </Link>
        </h2>
        <div className="row">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('jhipsterMonolithicSampleApp.orders.home.search')}
                  />
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={this.sort('customerId')}>
                  <Translate contentKey="jhipsterMonolithicSampleApp.orders.customerId">Customer Id</Translate> <FaSort />
                </th>
                <th />
              </tr>
            </thead>
