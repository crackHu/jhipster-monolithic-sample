...
import com.hustack.sample.domain.Customer;
import com.hustack.sample.repository.CustomerRepository;
import com.hustack.sample.service.CustomerService;
import com.hustack.sample.repository.search.CustomerSearchRepository;
import com.hustack.sample.service.dto.CustomerDTO;
import com.hustack.sample.service.mapper.CustomerMapper;
...
public class CustomerResourceIntTest {
     ...
     *
     * @see com.hustack.sample.repository.search.CustomerSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createCustomer() throws Exception {
        ...
        assertThat(testCustomer.getShardingId()).isEqualTo(DEFAULT_SHARDING_ID);
    ...
    public void updateCustomer() throws Exception {
        ...
        Customer testCustomer = customerList.get(customerList.size() - 1);
        assertThat(testCustomer.getShardingId()).isEqualTo(UPDATED_SHARDING_ID);
